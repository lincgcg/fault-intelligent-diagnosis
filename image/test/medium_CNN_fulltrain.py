...
valid_data = datasets.ImageFolder(root='/mnt/mxy/linchungang/image_diagnosis/fig/valid', transform=transform)
...
torch.save(model.state_dict(), '/mnt/mxy/linchungang/image_diagnosis/0715_12/medium_CNN_32.pth')
