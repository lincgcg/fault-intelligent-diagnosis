...
model = MultiModalNet()
file_path = "./model/multimodal_CNN.pth"
...
## 这里
FIGURE_PATH：这里填写预保存的图片路径

test_path = os.path.join(TEST_DATA_PATH, "test.csv")

dataset = TestImageFolder(FIGURE_PATH, test_path, transform=transform)
...
output_file_path = os.path.join(RES_PATH, "result.csv")
